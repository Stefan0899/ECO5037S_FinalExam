...
accounts = {
    "liquidity_provider1": {
        "address": "NG4WHDG64XSKZ3T3QYM73CQ4AFAR25U5GB7DNWKQWVHETBJLXVRPP6AG5I",
        "private_key": "rJixOkvbheTxkup7VX5MxSke5LRhUimQiT99ZMn+FKRpuWOM3uXkrO57hhn9ihwBQR12nTB+NtlQtU5JhSu9Yg=="
    },
    "liquidity_provider2": {
        "address": "ZUELPJY5LENC77FDKXM5SUENGSS5ZGY6BSCFETMAJK7YF6HF443ZX7SGBE",
        "private_key": "BmdhS5Qbf5fc8MD2rDMXf2iSRwDmK9kkm42zlimSJy/NCLenHVkaL/yjVdnZUI00pdybHgyEUk2ASr+C+OXnNw=="
    },
    "liquidity_pool": {
        "address": "FJVUS4M5MAPUGFGGA4M4DSPXFVZ5PFMBTZKH6BO4G4OSFBWRP6XO23WIUM",
        "private_key": "XCLSN2ZeenHxahU9030TYbyuMwIzBhPwrp83XHARVUQqa0lxnWAfQxTGBxnByfctc9eVgZ5UfwXcNx0ihtF/rg=="
    },
    "creator": {
        "address": "JQVFSCCXANT5VU6WTFYXVLL52LOSPMMKKGSSH5G5QHEC2SNRRAO7Z635CI",
        "private_key": "H4LD3WbqyoT/5Xo0feIZ4eQ14EOiNGkNWN7uWKWDHKpMKlkIVwNn2tPWmXF6rX3S3SexilGlI/TdgcgtSbGIHQ=="
    },
    "trader1": {
        "address": "4JJ6W32DIOLT6FWTM6N2K2HXXSZIZFFZATKKBYXXXTCV7EBJEOQS7IDOUA",
        "private_key": "KETUaYChlW9Ri5GAVwPkL8f8M8zVfVz2CFrEn19ryoviU+tvQ0OXPxbTZ5ulaPe8soyUuQTUoOL3vMVfkCkjoQ=="
    },
    "trader2": {
        "address": "HU5BCY72UZCFTS66UBIYECUWABIUH5HO3GEI27FZNGVEASMU3YAEVI6CPI",
        "private_key": "2JuB38S2s8DehPEfdxMOyeP/RpxoGCZiS6agYJKURIw9OhFj+qZEWcveoFGCCpYAUUP07tmIjXy5aapASZTeAA=="
    },
}
...
def check_balance(algod_client, address, asset_id, asset_name="ALGO"):
    ...
    for asset in account_info.get('assets', []):
        if asset['asset-id'] == asset_id:
            return asset['amount'] / 100  # 2 decimal places for assets like UCTZAR
...
def opt_in_to_asset(algod_client, account_address, account_private_key, asset_id):
    ...
    txn = AssetTransferTxn(
        ...
        index=asset_id              # Asset ID for UCTZAR or LP Tokens
    )
...
if __name__ == "__main__":
    ...
    # Mint UCTZAR stablecoin by creator
    ...
    add_liquidity(
        ...
        algo_amount=10,  # 10 ALGOs
        uctzar_amount=2000,  # 20 UCTZAR (in micro-units)
        asset_id=uctzar_asset_id,
        lp_asset_id=lp_asset_id,
        lp_total_supply=1_000_000
    )
